...
| Inverted Index | OpenSearch 2 (port 9200) | BM25 lexical search |
...
| Text Search | OpenSearch 2 | 9200 | BM25 lexical search |
| Migration | Alembic | — | Quản lý PostgreSQL schema |
| ORM | SQLAlchemy | — | Python ↔ PostgreSQL mapping |
...
services:
  ...
  opensearch: # Text search — port 9200
```
...
| OpenSearch cho BM25 | OpenSearch | Full-text search, ranking functions |
